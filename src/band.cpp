...
Band::Band(uint8_t u8Number, uint16_t u16NumOfLEDs) : _u8Number(u8Number),
                                                      _u16NumOfLEDs(u16NumOfLEDs)
{
}

Band::Band(uint8_t u8Number, uint16_t u16MinFreq, uint16_t u16MaxFreq, uint16_t u16NumOfLEDs) : _u8Number(u8Number),
                                                                                                _u16NumOfLEDs(u16NumOfLEDs),
